...
echo "Downloading Snowflake - snowflake-jdbc-${jdbc_snowflake_driver_version}.jar Version "
...
export jdbc_snowflake_driver_download_url=https://repo1.maven.org/maven2/net/snowflake/snowflake-jdbc/${jdbc_snowflake_driver_version}/snowflake-jdbc-${jdbc_snowflake_driver_version}.jar
curl -SOLs ${jdbc_snowflake_driver_download_url}
