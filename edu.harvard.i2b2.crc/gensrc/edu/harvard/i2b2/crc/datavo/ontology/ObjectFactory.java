...
public class ObjectFactory {
    ...
    private final static QName _GetDerivedFactColumns_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "get_derived_fact_columns");
    ...
    private final static QName _SetDblookup_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "set_dblookup");
    private final static QName _DeleteDblookup_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "delete_dblookup");
    private final static QName _Modifiers_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "modifiers");
    private final static QName _Dblookups_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "dblookups");
    ...
    private final static QName _DerivedFactTableColumns_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "derivedFactTableColumns");
    private final static QName _GetNameInfo_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "get_name_info");
    private final static QName _GetAllDblookups_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "get_all_dblookups");
    ...
    private final static QName _LoadMetadata_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "load_metadata");
    private final static QName _GetDblookup_QNAME = new QName("http://www.i2b2.org/xsd/cell/ont/1.1/", "get_dblookup");
    ...
    /**
     * Create an instance of {@link MetadataLoadType }
     * 
     */
    public MetadataLoadType createMetadataLoadType() {
        return new MetadataLoadType();
    }
    ...
    /**
     * Create an instance of {@link DerivedFactColumnsType }
     * 
     */
    public DerivedFactColumnsType createDerivedFactColumnsType() {
        return new DerivedFactColumnsType();
    }
    ...
    /**
     * Create an instance of {@link OntologyDataType }
     * 
     */
    public OntologyDataType createOntologyDataType() {
        return new OntologyDataType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "get_derived_fact_columns")
    public JAXBElement<GetTermInfoType> createGetDerivedFactColumns(GetTermInfoType value) {
        return new JAXBElement<GetTermInfoType>(_GetDerivedFactColumns_QNAME, GetTermInfoType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "set_dblookup")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "delete_dblookup")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "dblookups")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DerivedFactColumnsType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "derivedFactTableColumns")
    public JAXBElement<DerivedFactColumnsType> createDerivedFactTableColumns(DerivedFactColumnsType value) {
        return new JAXBElement<DerivedFactColumnsType>(_DerivedFactTableColumns_QNAME, DerivedFactColumnsType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "get_all_dblookups")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MetadataLoadType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "load_metadata")
    public JAXBElement<MetadataLoadType> createLoadMetadata(MetadataLoadType value) {
        return new JAXBElement<MetadataLoadType>(_LoadMetadata_QNAME, MetadataLoadType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/ont/1.1/", name = "get_dblookup")
