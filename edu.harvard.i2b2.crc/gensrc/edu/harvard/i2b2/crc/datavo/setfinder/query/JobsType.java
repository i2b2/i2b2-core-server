 ...
 *       &lt;sequence>
 *         &lt;element name="project" type="{http://www.i2b2.org/xsd/cell/crc/psm/1.1/}jobType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class JobsType {
    ...
    protected List<JobType> project;
     ...
     * 
     */
    public List<JobType> getProject() {
        if (project == null) {
            project = new ArrayList<JobType>();
        }
        return this.project;
    }
