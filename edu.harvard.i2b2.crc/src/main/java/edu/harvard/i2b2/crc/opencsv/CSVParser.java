...
import edu.harvard.i2b2.crc.opencsv.enums.CSVReaderNullFieldIndicator;
import edu.harvard.i2b2.crc.opencsv.util.StringUtils;

import static edu.harvard.i2b2.crc.opencsv.enums.CSVReaderNullFieldIndicator.NEITHER;
...
public class CSVParser {
	...
	public static final boolean DO_ENCRYPT = false;
	/**
