 ...
 * </ul>
 * This annotation must be used with either {@link edu.harvard.i2b2.crc.opencsv.bean.CsvBindByName}
 * or {@link edu.harvard.i2b2.crc.opencsv.bean.CsvBindByPosition}, otherwise it is ignored.
 *
