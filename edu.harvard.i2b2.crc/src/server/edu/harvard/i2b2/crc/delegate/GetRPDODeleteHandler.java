...
public class GetRPDODeleteHandler extends RPDOReqHandler {
	private static Log log = LogFactory.getLog(GetRPDODeleteHandler.class);
	...
	public GetRPDODeleteHandler(GetRPDODataMessage requestMsg, String requestElementString) throws I2B2Exception{
		try {
	...
	public String execute() throws I2B2Exception {
		...
		int response = 0;
		try {
			response = RPDODao.getRPDODelete(rpdoType.getId());
		} catch (Exception e1) {
