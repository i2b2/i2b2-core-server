 ...
 * @author rkuttan
 */
public abstract class OntologyAxisAbstract {
...
public static MessageHeaderType generateMessageHeader() {
	...
	edu.harvard.i2b2.ontology.datavo.i2b2message.ApplicationType appType = new edu.harvard.i2b2.ontology.datavo.i2b2message.ApplicationType();
