 ...
 * 
 */
public class ModifierXMLWriterUtil extends PatientDataXMLWriterUtil {
	...
	public ModifierXMLWriterUtil(XMLEventWriter eventWriter)
	...
	public void buildConcept(ResultSet conceptResultSet) throws Exception {
		...
		createNode(eventWriter, "modifier_path", conceptResultSet
				.getString("c_dimcode"));
		createNode(eventWriter, "modifier_cd", conceptResultSet
				.getString("c_basecode"));
		createNode(eventWriter, "name_char", conceptResultSet
				.getString("c_name"));

		eventWriter.add(eventFactory.createEndElement("", "", "modifier"));
		eventWriter.add(end);
