...
public class GetModifierCodeInfoDataMessage extends RequestDataMessage{

	private static Log log = LogFactory.getLog(GetModifierCodeInfoDataMessage.class);

	public GetModifierCodeInfoDataMessage(String requestVdo) throws I2B2Exception {
		super(requestVdo);
	}
