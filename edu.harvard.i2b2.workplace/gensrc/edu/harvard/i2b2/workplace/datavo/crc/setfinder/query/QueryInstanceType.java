 ...
 *         &lt;element name="query_result_instance_type" type="{http://www.i2b2.org/xsd/cell/crc/psm/1.1/}query_result_instanceType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryInstanceType {
    ...
    @XmlElement(name = "query_result_instance_type", required = true)
    protected List<QueryResultInstanceType> queryResultInstanceType;
    ...
    /**
     * Gets the value of the queryResultInstanceType property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the queryResultInstanceType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQueryResultInstanceType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<QueryResultInstanceType> getQueryResultInstanceType() {
        if (queryResultInstanceType == null) {
            queryResultInstanceType = new ArrayList<QueryResultInstanceType>();
        }
        return this.queryResultInstanceType;
    }
