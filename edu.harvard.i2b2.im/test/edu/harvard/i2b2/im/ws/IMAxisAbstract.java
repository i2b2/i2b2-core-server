...
import edu.harvard.i2b2.im.datavo.i2b2message.PasswordType;
 ...
 * @author rkuttan
 */
public abstract class IMAxisAbstract {
...
public static MessageHeaderType generateMessageHeader() {
	...
	edu.harvard.i2b2.im.datavo.i2b2message.ApplicationType appType = new edu.harvard.i2b2.im.datavo.i2b2message.ApplicationType();
